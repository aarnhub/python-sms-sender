...
def apisettings():
  ...
  if choicest == "1":
          input_number = input("  1.Enter Proovl.com Phone number\n")
          input_userid = input("  2.Enter Proovl.com UserID\n") 
          input_token = input("   3.Enter Proovl.com Token\n") 
          try:
              ...
              print("\033[1;33m=== Number: " + otput[0] + "\033[1;m")
              print("\033[1;33m=== UserID: " + otput[1] + "\033[1;m")
              print("\033[1;33m=== Token: " + otput[2] + "\033[1;m")       
          except:
...
def singlesms():
  ...
  try:
    ...
    f.close()
    if input("Send new message? \033[1;32m(Y/N)\033[1;m").strip().upper() != 'Y':
      print("\033[H\033[J")
      mainmenu()
      return
    else:
...
def bulksms():
  ...
  try:
    ...
    if z[0] == "Error":
      print("\033[1;31m== Error. Text messages not sent ==\033[1;m")
    else:
      print("\033[1;32m== All messages has been sent! ==\033[1;m")
    f.close()
    if input("Send new message? \033[1;32m(Y/N)\033[1;m").strip().upper() != 'Y':
      print("\033[H\033[J")
      mainmenu()
